...
const timelineData: TimelineItem[] = [
  {
    ...
    description:
      "Joined Erode Sengunthar Engineering College to pursue Bachelor of Engineering in Electronics & Communication Engineering. Began exploring programming alongside core electronics.",
    tag: "education",
  },
  {
    year: "2024",
    ...
    description:
      "Built an Android-based voice controlled autonomous vehicle using Arduino. The system processes wireless voice commands for precise movements — a stepping stone into embedded systems and automation.",
    tag: "achievement",
  },
  {
    year: "2025",
    ...
    description:
      "Currently working as a Full Stack Developer intern, gaining hands-on experience building real-world web applications with modern technologies.",
    tag: "experience",
  },
  {
    year: "2026",
    ...
    description:
      "Designed and implemented an efficient LDPC Encoder & Decoder on FPGA for 5G communication systems using a custom Python-based VeCoGen tool. Achieved 22% higher throughput and 36.1% reduction in LUT utilization on Artix-7 FPGA.",
    tag: "achievement",
  },
  {
    year: "2026",
    ...
    description:
      "Completing Bachelor of Engineering in Electronics & Communication Engineering from Erode Sengunthar Engineering College. Ready to take on full-time roles as a Full Stack Developer.",
    tag: "education",
  },
];
